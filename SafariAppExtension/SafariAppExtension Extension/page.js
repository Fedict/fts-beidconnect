//console.log("injection page script on " + document.location.href);
...
function EIDChromeExt() {
   ...
   window.addEventListener("message", function(event) {
      ...
      if((event.data.src ) && (event.data.src === "background")) {
         console.log("Page received from : " + event.data.src);
         ...
         if(event.data.correlationId) {
            ...
            if(event.data.result === "OK") {
               console.log("resolve " + event.data);
